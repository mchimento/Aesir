...
instance Print AbsPPDATE where
  prt i e = case e of
   AbsPPDATE imports model templates cinvariants iprop methods -> prPrec i 0 (concatD [prt 0 imports , prt 0 model , prt 0 templates , prt 0 cinvariants , prt 0 iprop , prt 0 methods])
